...
class ShippingFinanceDialog extends StatelessWidget {
  const ShippingFinanceDialog({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ShippingStoresController>(
      id: ShippingStoresController.financeFormId,
      builder: (controller) {
        final store = controller.financeStore;
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: AppButton(
                            ...
                            onPressed: busy
                                ? null
                                : () => controller.adjustShipmentWallet(
                                      isAdd: false,
                                    ),
                          ),
                        ),
                    ...
                    NegativeBalanceRestrictToggle(
                      restricted:
                          controller.isFinanceNegativeRestricted(store),
                      enabled: !busy,
                      onChanged: controller.setFinanceNegativeRestricted,
                    ),
                    const SizedBox(height: AppSpacing.md),
                    if (!controller.isFinanceNegativeRestricted(store)) ...[
                      AppTextField(
