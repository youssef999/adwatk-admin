...
class VendorMoneyRequestCard extends StatelessWidget {
  const VendorMoneyRequestCard({
    super.key,
  ...
  final VendorMoneyRequestModel request;
  final bool selected;
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _MiniStat(
                label: 'معاملات',
                value: '${request.vendorsWalletIds.length}',
              ),
            ],
          ),
          const SizedBox(height: AppSpacing.sm),
